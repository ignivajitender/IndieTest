 ...
 */
public interface OnCommentListItemClickListnerTest2 {
      void onCommentListItemClicked(WallPostAdapter.RecyclerViewHolders view, int position, String postId,String type);
}
