            ...
            case R.id.iv_delete_report_post:
                try {
                    if (ACTION.equalsIgnoreCase("DELETE")) {
                        showRemovePostAlertDialog(getResources().getString(R.string.delete_post), CommentActivity.this, postId,POST);
                    } else {
...
//            removeComment(commentId);
        showRemovePostAlertDialog(getResources().getString(R.string.remove_comment),CommentActivity.this,commentId,COMMENT);
        }
    };
